...
namespace Manifest_Utility
{
	...
	constexpr MFchar ToUpperChar(MFchar c)
	{
	...
	public:
		...
		constexpr SymbolHash(const MFchar* symbol) : hash{ HashFnv1a(symbol) } {}
	...
	private:
		...
		static constexpr MFu64 HashFnv1a(const MFchar* str, MFu64 hash = FNV1A_BASIS) {
